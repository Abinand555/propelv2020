...
public class InsertDao {
	...
	private static String CREATE_STU = "INSERT INTO student (SNAME,BDAY,GENDER,ADDR,EMAILADDR,PHNO,QUAL,ISACTIVE) VALUES (?,?,?,?,?,?,?,'Y')";

	// query to view all patient details
	private static String VIEW_ALL = "SELECT * FROM student";
